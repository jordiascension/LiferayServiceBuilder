...
import com.sinensia.business.service.LibroService;
import com.sinensia.business.service.LibroServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sinensia.business.service.impl.LibroServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.sinensia.business.service.impl.LibroServiceImpl
 * @generated
 */
public abstract class LibroServiceBaseImpl
	extends BaseServiceImpl implements IdentifiableOSGiService, LibroService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LibroService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LibroServiceUtil</code>.
	 */
	 ...
	 */
	public com.sinensia.business.service.LibroLocalService
		getLibroLocalService() {
	...
	public void setLibroLocalService(
		com.sinensia.business.service.LibroLocalService libroLocalService) {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(libroService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LibroService.class.getName();
	}
	...
	private void _setServiceUtilService(LibroService libroService) {
		try {
			Field field = LibroServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, libroService);
		}
	...
	@BeanReference(type = com.sinensia.business.service.LibroLocalService.class)
	protected com.sinensia.business.service.LibroLocalService libroLocalService;

	@BeanReference(type = LibroService.class)
